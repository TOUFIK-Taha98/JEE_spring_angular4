...
une application Web JEE basée sur une partie BackEnd développée en utilisant Spring Framework et  la partie FrontEnt développée en utilisant le Framework Angular 4. 

Elle inclue les partie suivantes :

 Partie A : Partie Back End:
